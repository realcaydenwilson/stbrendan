...
var texturePaths = ['./panoramas/Church_360_LQ.jpg', './panoramas/Theater_360_LQ.jpg', './panoramas/Stage_360_LQ.jpg'];
...
var texture = textureLoader.load('./panoramas/Church_360_LQ.jpg');
...
// Function to load the next texture
function loadNextTexture() {
  ...
  // Load new texture
  var newTexture = textureLoader.load(texturePaths[currentTextureIndex]);
  sphere.material.map = newTexture;
  sphere.material.needsUpdate = true;
}

var loadButton = document.getElementById('view-button');
loadButton.addEventListener('click', loadNextTexture);
